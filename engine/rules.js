...
const RESPUESTAS_CARRERA = {
    ciencia_datos: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial de la carrera de Ciencia de Datos se estructura de la siguiente manera:<br><ul><li><b>1° Año:</b>  se cursan Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas Profesionalizantes I y EDI I</li>
<li><b>2° Año:</b>  se cursan Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos y Algoritmos, Aprendizaje Automático I, Prácticas Profesionalizantes II y EDI II</li>
<li><b>3° Año:</b>  se cursan Aprendizaje Profundo, Minería de Datos y Big Data, Procesamiento del Lenguaje Natural (NLP), Ética, Privacidad y Regulación de Datos, Seguridad de la Información y Prácticas Profesionalizantes III</li></ul>",
            "Le detallamos la distribución anual de materias de Ciencia de Datos:<br><ul><li><b>1° Año:</b>  Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas Profesionalizantes I y EDI I; </li>
<li><b>2° Año:</b>  Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos y Algoritmos, Aprendizaje Automático I, Prácticas Profesionalizantes II y EDI II; </li>
<li><b>3° Año:</b>  Aprendizaje Profundo, Minería de Datos y Big Data, Procesamiento del Lenguaje Natural (NLP), Ética, Privacidad y Regulación de Datos, Seguridad de la Información y Prácticas Profesionalizantes III</li></ul>",
            "Le recordamos que el plan de estudios oficial de la carrera de Ciencia de Datos se estructura de la siguiente manera:<br><ul><li><b>1° Año:</b>  se cursan Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas Profesionalizantes I y EDI I</li>
<li><b>2° Año:</b>  se cursan Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos y Algoritmos, Aprendizaje Automático I, Prácticas Profesionalizantes II y EDI II</li>
<li><b>3° Año:</b>  se cursan Aprendizaje Profundo, Minería de Datos y Big Data, Procesamiento del Lenguaje Natural (NLP), Ética, Privacidad y Regulación de Datos, Seguridad de la Información y Prácticas Profesionalizantes III. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le presentamos detalladamente el plan de estudios completo de Ciencia de Datos:<br><ul><li><b>1° Año:</b>  Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas I y EDI I</li>
<li><b>2° Año:</b>  Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos y Algoritmos, Aprendizaje Automático I, Prácticas II y EDI II</li>
<li><b>3° Año:</b>  Aprendizaje Profundo, Minería de Datos y Big Data, Procesamiento del Lenguaje Natural (NLP), Ética, Privacidad y Regulación de Datos, Seguridad de la Información y Prácticas III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias obligatorias de Ciencia de Datos por año son:<br><ul><li><b>1° Año:</b>  Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas Profesionalizantes I, EDI I</li>
<li><b>2° Año:</b>  Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos, Aprendizaje Automático I, Prácticas II, EDI II</li>
<li><b>3° Año:</b>  Aprendizaje Profundo, Minería de Datos y Big Data, NLP, Ética, Seguridad de la Información y Prácticas III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le presentamos detalladamente el plan de estudios completo de Ciencia de Datos:<br><ul><li><b>1° Año:</b>  Álgebra, Análisis Matemático, Programación I, Ciencia y TIC, Base de Datos, Redes, Prácticas I y EDI I</li>
<li><b>2° Año:</b>  Probabilidad y Estadística, Programación II, Bases de Datos Avanzadas, Estructura de Datos y Algoritmos, Aprendizaje Automático I, Prácticas II y EDI II</li>
<li><b>3° Año:</b>  Aprendizaje Profundo, Minería de Datos y Big Data, Procesamiento del Lenguaje Natural (NLP), Ética, Privacidad y Regulación de Datos, Seguridad de la Información y Prácticas III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    gestion_juridica: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Gestión Jurídica consta de:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática aplicada a la gestión administrativa y judicial I, Gestión de calidad, Comunicación oral y escrita, Derecho público I y Práctica profesionalizante I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas en el trabajo, Gestión del automotor e inmobiliario, Derecho público II, EDI I, Informática aplicada a la gestión administrativa y judicial II y Práctica profesionalizante II</li>
<li><b>3° Año:</b>  Gestión administrativa y judicial, Gestión notarial, Planeamiento estratégico, Ética y deontología del técnico en gestión jurídica, Herramientas de mediación y negociación, Gestión previsional, EDI II, Derecho privado III y Práctica profesionalizante III</li></ul>",
            "Le detallamos la distribución curricular anual de Gestión Jurídica:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática I, Gestión de calidad, Comunicación, Derecho público I, Práctica I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas, Gestión del automotor e inmobiliario, Derecho público II, EDI I, Informática II, Práctica II</li>
<li><b>3° Año:</b>  Gestión administrativa y judicial, Gestión notarial, Planeamiento estratégico, Ética y deontología, Mediación y negociación, Gestión previsional, EDI II, Derecho privado III y Práctica III</li></ul>",
            "Le recordamos que el plan de estudios oficial para Gestión Jurídica consta de:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática aplicada a la gestión administrativa y judicial I, Gestión de calidad, Comunicación oral y escrita, Derecho público I y Práctica profesionalizante I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas en el trabajo, Gestión del automotor e inmobiliario, Derecho público II, EDI I, Informática aplicada a la gestión administrativa y judicial II y Práctica profesionalizante II</li>
<li><b>3° Año:</b>  Gestión administrativa y judicial, Gestión notarial, Planeamiento estratégico, Ética y deontología del técnico en gestión jurídica, Herramientas de mediación y negociación, Gestión previsional, EDI II, Derecho privado III y Práctica profesionalizante III. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Gestión Jurídica:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática I, Gestión de calidad, Comunicación, Derecho público I, Práctica I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas, Gestión del automotor e inmobiliario, Derecho público II, EDI I, Informática II, Práctica II</li>
<li><b>3° Año:</b>  Gestión administrativa y judicial, Gestión notarial, Planeamiento estratégico, Ética y deontología, Mediación y negociación, Gestión previsional, EDI II, Derecho privado III y Práctica III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias de Gestión Jurídica son:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática I, Gestión de calidad, Comunicación, Derecho público I, Práctica I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas, Gestión automotor/inmobiliario, Derecho público II, EDI I, Informática II, Práctica II</li>
<li><b>3° Año:</b>  Gestión administrativa/judicial, Gestión notarial, Planeamiento estratégico, Ética, Mediación, Gestión previsional, EDI II, Derecho privado III, Práctica III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Gestión Jurídica:<br><ul><li><b>1° Año:</b>  Introducción al derecho, Derecho privado I, Informática I, Gestión de calidad, Comunicación, Derecho público I, Práctica I</li>
<li><b>2° Año:</b>  Derecho privado II, Relaciones humanas, Gestión del automotor e inmobiliario, Derecho público II, EDI I, Informática II, Práctica II</li>
<li><b>3° Año:</b>  Gestión administrativa y judicial, Gestión notarial, Planeamiento estratégico, Ética y deontología, Mediación y negociación, Gestión previsional, EDI II, Derecho privado III y Práctica III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    ciencia_politica: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Ciencia Política se distribuye en 4 años de la siguiente manera:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Introducción a la Ciencia Política, Sociología, Construcción para la Ciudadanía, Introducción al Derecho y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Educación Sexual Integral, Sujeto de la Educación, Teoría Política I, Derecho Constitucional, Didáctica de la Ciencia Política, Derecho Privado I y Práctica II</li>
<li><b>3° Año:</b>  Integración de TIC, Sociología de la Educación, Formación Ética, Política y Relaciones Internacionales, Teoría Política II, Derecho Privado II, Economía Política y Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, Derecho Administrativo, Investigación en Ciencia Política, Derecho del Trabajo, Unidad de Definición Institucional y Residencia Pedagógica</li></ul>",
            "Le detallamos la estructura curricular de Ciencia Política:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Introducción a la Ciencia Política, Sociología, Construcción para la Ciudadanía, Introducción al Derecho, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, ESI, Sujeto de la Educación, Teoría Política I, Derecho Constitucional, Didáctica, Derecho Privado I, Práctica II</li>
<li><b>3° Año:</b>  Integración de TIC, Sociología de la Educación, Formación Ética, Política y Relaciones Internacionales, Teoría Política II, Derecho Privado II, Economía Política, Práctica III</li>
<li><b>4° Año:</b>  Ética Docente, Derecho Administrativo, Investigación, Derecho del Trabajo, Unidad Institucional, Residencia</li></ul>",
            "Le recordamos que el plan de estudios oficial para Ciencia Política se distribuye en 4 años de la siguiente manera:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Introducción a la Ciencia Política, Sociología, Construcción para la Ciudadanía, Introducción al Derecho y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Educación Sexual Integral, Sujeto de la Educación, Teoría Política I, Derecho Constitucional, Didáctica de la Ciencia Política, Derecho Privado I y Práctica II</li>
<li><b>3° Año:</b>  Integración de TIC, Sociología de la Educación, Formación Ética, Política y Relaciones Internacionales, Teoría Política II, Derecho Privado II, Economía Política y Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, Derecho Administrativo, Investigación en Ciencia Política, Derecho del Trabajo, Unidad de Definición Institucional y Residencia Pedagógica. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo del Profesorado:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización, Didáctica, Introducción a la Ciencia Política, Sociología, Ciudadanía, Introducción al Derecho, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, ESI, Sujeto, Teoría Política I, Derecho Constitucional, Didáctica, Derecho Privado I, Práctica II</li>
<li><b>3° Año:</b>  TIC, Sociología Educativa, Formación Ética, Política y Relaciones Internacionales, Teoría Política II, Derecho Privado II, Economía, Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, Derecho Administrativo, Investigación en Ciencia Política, Derecho del Trabajo, Unidad Institucional y Residencia Pedagógica</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las asignaturas por año del profesorado de Ciencia Política son:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Intro. Ciencia Política, Sociología, Ciudadanía, Intro. Derecho, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia Educación, ESI, Sujeto, Teoría Política I, Derecho Constitucional, Didáctica, Derecho Privado I, Práctica II</li>
<li><b>3° Año:</b>  TIC, Sociología Educación, Formación Ética, Política Internacional, Teoría Política II, Derecho Privado II, Economía, Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, Derecho Administrativo, Investigación, Derecho del Trabajo, Unidad Institucional, Residencia</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo del Profesorado:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización, Didáctica, Introducción a la Ciencia Política, Sociología, Ciudadanía, Introducción al Derecho, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, ESI, Sujeto, Teoría Política I, Derecho Constitucional, Didáctica, Derecho Privado I, Práctica II</li>
<li><b>3° Año:</b>  TIC, Sociología Educativa, Formación Ética, Política y Relaciones Internacionales, Teoría Política II, Derecho Privado II, Economía, Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, Derecho Administrativo, Investigación en Ciencia Política, Derecho del Trabajo, Unidad Institucional y Residencia Pedagógica. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    educacion_especial: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Educación Especial se estructura en 4 años de la siguiente manera:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Neuropsicobiología del Desarrollo, Sujeto de la Educación, Educación Temprana, Abordaje Pedagógico I y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Didáctica de la Lengua y la Literatura, Didáctica de la Matemática, Comunicación, Lenguaje y sus alteraciones, Trastornos en el desarrollo, Abordaje Pedagógico II y Práctica II</li>
<li><b>3° Año:</b>  TIC y Discapacidad, Sociología de la Educación, Didáctica de Ciencias Sociales, Didáctica de Ciencias Naturales, Abordaje Pedagógico III, Abordajes Pedagógicos Complejos y Práctica III</li>
<li><b>4° Año:</b>  ESI y Discapacidad Intelectual, Ética Profesional Docente, Perspectiva del adulto con Discapacidad Intelectual, dos Unidades de opción institucional y Residencia Pedagógica</li></ul>",
            "Le detallamos la distribución anual de materias de Educación Especial:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Neuropsicobiología, Sujeto de la Educación, Educación Temprana, Abordaje Pedagógico I, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de la Educación, Didáctica de la Lengua, Didáctica de la Matemática, Comunicación y Lenguaje, Trastornos en el desarrollo, Abordaje Pedagógico II, Práctica II</li>
<li><b>3° Año:</b>  TIC y Discapacidad, Sociología de la Educación, Didáctica de Sociales, Didáctica de Naturales, Abordaje Pedagógico III, Abordajes Complejos, Práctica III</li>
<li><b>4° Año:</b>  ESI y Discapacidad, Ética Docente, Perspectiva del Adulto con Discapacidad, dos Unidades Institucionales, Residencia</li></ul>",
            "Le recordamos que el plan de estudios oficial para Educación Especial se estructura en 4 años de la siguiente manera:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Neuropsicobiología del Desarrollo, Sujeto de la Educación, Educación Temprana, Abordaje Pedagógico I y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Didáctica de la Lengua y la Literatura, Didáctica de la Matemática, Comunicación, Lenguaje y sus alteraciones, Trastornos en el desarrollo, Abordaje Pedagógico II y Práctica II</li>
<li><b>3° Año:</b>  TIC y Discapacidad, Sociología de la Educación, Didáctica de Ciencias Sociales, Didáctica de Ciencias Naturales, Abordaje Pedagógico III, Abordajes Pedagógicos Complejos y Práctica III</li>
<li><b>4° Año:</b>  ESI y Discapacidad Intelectual, Ética Profesional Docente, Perspectiva del adulto con Discapacidad Intelectual, dos Unidades de opción institucional y Residencia Pedagógica. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. El plan de estudios de Educación Especial consta de:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Neuropsicobiología, Sujeto, Educación Temprana, Abordaje I, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Didáctica de Lengua y Matemática, Comunicación y Lenguaje, Trastornos en el desarrollo, Abordaje II, Práctica II</li>
<li><b>3° Año:</b>  TIC y Discapacidad, Sociología, Didáctica de Sociales/Naturales, Abordaje III, Abordajes Complejos, Práctica III</li>
<li><b>4° Año:</b>  ESI y Discapacidad, Docente, Perspectiva del Adulto con Discapacidad, dos Unidades Institucionales y Residencia Pedagógica</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias anuales obligatorias de la carrera son:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Neuropsicobiología, Sujeto, Ed. Temprana, Abordaje I, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Didáctica de Lengua/Matemática, Comunicación, Trastornos en desarrollo, Abordaje II, Práctica II</li>
<li><b>3° Año:</b>  TIC, Sociología, Didáctica de Sociales/Naturales, Abordaje III, Abordajes Complejos, Práctica III</li>
<li><b>4° Año:</b>  ESI, Ética, Perspectiva del Adulto, dos materias de opción institucional, Residencia</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. El plan de estudios de Educación Especial consta de:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Neuropsicobiología, Sujeto, Educación Temprana, Abordaje I, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Didáctica de Lengua y Matemática, Comunicación y Lenguaje, Trastornos en el desarrollo, Abordaje II, Práctica II</li>
<li><b>3° Año:</b>  TIC y Discapacidad, Sociología, Didáctica de Sociales/Naturales, Abordaje III, Abordajes Complejos, Práctica III</li>
<li><b>4° Año:</b>  ESI y Discapacidad, Docente, Perspectiva del Adulto con Discapacidad, dos Unidades Institucionales y Residencia Pedagógica. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    ciencias_sagradas: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial de Ciencias Sagradas se organiza en 4 años:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Teología Fundamental, Seminario Bíblico I, Historia de la Filosofía y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Sujeto de la Educación, Didáctica de la Formación Religiosa (Inicial/Primaria), Cristología, Antropología Filosófica, Ética, Seminario Bíblico II y Práctica II</li>
<li><b>3° Año:</b>  ESI, Integración de TIC, Sociología de la Educación, Eclesiología, Formación Ética y Ciudadana, Bioética, Didáctica de la Formación Religiosa (Secundaria), Didáctica de la Formación Ética y Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, La Formación Religiosa y el Sujeto con Discapacidad, Ecumenismo y Diálogo Interreligioso, Tradiciones Religiosas y Religiosidad Popular, dos Unidades de Definición Institucional y Residencia Pedagógica</li></ul>",
            "Le detallamos la distribución anual de Ciencias Sagradas:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización, Didáctica, Teología Fundamental, Seminario Bíblico I, Historia de la Filosofía, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de la Educación, Sujeto de la Educación, Didáctica de la Formación Religiosa I, Cristología, Antropología Filosófica, Ética, Seminario Bíblico II, Práctica II</li>
<li><b>3° Año:</b>  ESI, TIC, Sociología de la Educación, Eclesiología, Formación Ética, Bioética, Didáctica de Formación Religiosa II, Didáctica de Formación Ética, Práctica III</li>
<li><b>4° Año:</b>  Ética Docente, Formación Religiosa y Discapacidad, Ecumenismo, Tradiciones Religiosas, dos Unidades Institucionales, Residencia</li></ul>",
            "Le recordamos que el plan de estudios oficial de Ciencias Sagradas se organiza en 4 años:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología Educacional, Alfabetización Académica, Didáctica General, Teología Fundamental, Seminario Bíblico I, Historia de la Filosofía y Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia de las Políticas Educativas, Sujeto de la Educación, Didáctica de la Formación Religiosa (Inicial/Primaria), Cristología, Antropología Filosófica, Ética, Seminario Bíblico II y Práctica II</li>
<li><b>3° Año:</b>  ESI, Integración de TIC, Sociología de la Educación, Eclesiología, Formación Ética y Ciudadana, Bioética, Didáctica de la Formación Religiosa (Secundaria), Didáctica de la Formación Ética y Práctica III</li>
<li><b>4° Año:</b>  Ética Profesional Docente, La Formación Religiosa y el Sujeto con Discapacidad, Ecumenismo y Diálogo Interreligioso, Tradiciones Religiosas y Religiosidad Popular, dos Unidades de Definición Institucional y Residencia Pedagógica. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. Las asignaturas de Ciencias Sagradas son:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Teología Fundamental, Seminario Bíblico I, Historia de la Filosofía, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Sujeto, Didáctica Formación Religiosa (Inicial/Primaria), Cristología, Antropología, Ética, Seminario Bíblico II, Práctica II</li>
<li><b>3° Año:</b>  ESI, TIC, Sociología, Eclesiología, Formación Ética, Bioética, Didáctica Formación Religiosa (Secundaria), Didáctica Formación Ética, Práctica III</li>
<li><b>4° Año:</b>  Ética Docente, Formación Religiosa y Discapacidad, Ecumenismo, Tradiciones Religiosas, dos Unidades de Definición Institucional y Residencia Pedagógica</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias obligatorias por año del profesorado de Ciencias Sagradas son:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Teología Fundamental, Seminario Bíblico I, Filosofía, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Sujeto, Didáctica de Religión I, Cristología, Antropología, Ética, Seminario Bíblico II, Práctica II</li>
<li><b>3° Año:</b>  ESI, TIC, Sociología, Eclesiología, Formación Ética, Bioética, Didáctica de Religión II, Didáctica de Ética, Práctica III</li>
<li><b>4° Año:</b>  Docente, Religión y Discapacidad, Ecumenismo, Tradiciones Religiosas, dos Unidades de Definición Institucional, Residencia</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. Las asignaturas de Ciencias Sagradas son:<br><ul><li><b>1° Año:</b>  Pedagogía, Psicología, Alfabetización, Didáctica, Teología Fundamental, Seminario Bíblico I, Historia de la Filosofía, Práctica I</li>
<li><b>2° Año:</b>  Filosofía, Historia, Sujeto, Didáctica Formación Religiosa (Inicial/Primaria), Cristología, Antropología, Ética, Seminario Bíblico II, Práctica II</li>
<li><b>3° Año:</b>  ESI, TIC, Sociología, Eclesiología, Formación Ética, Bioética, Didáctica Formación Religiosa (Secundaria), Didáctica Formación Ética, Práctica III</li>
<li><b>4° Año:</b>  Ética Docente, Formación Religiosa y Discapacidad, Ecumenismo, Tradiciones Religiosas, dos Unidades de Definición Institucional y Residencia Pedagógica. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    gestion_ambiental: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Gestión Ambiental consta de:<br><ul><li><b>1° Año:</b>  Biología, Matemática y Estadística, Física, Química, Ciencias de la Tierra, Inglés, Dinámicas Sociales y Ambientales, Gestión Ambiental Digital, Alfabetización Académica y Comunicación, y Práctica Profesionalizante I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Gestión de Residuos, Química Ambiental, Contaminación y Toxicología Ambiental, Espacio de Definición Institucional I (EDI I), Economía Ambiental, Ecología y Desarrollo Sostenible, Metodología de la Investigación y Práctica Profesionalizante II</li>
<li><b>3° Año:</b>  Educación y Comunicación Ambiental, Ordenamiento Ambiental del Territorio, Ética y Deontología Profesional, Sistemas de Gestión y Auditorías Ambientales, Evaluaciones de Impacto Ambiental, Seguridad Ambiental y Laboral, EDI II, Gestión Ambiental Minera, Planificación y Gestión de Proyectos, y Práctica Profesional III</li></ul>",
            "Le detallamos la distribución anual de materias de Gestión Ambiental:<br><ul><li><b>1° Año:</b>  Biología, Matemática/Estadística, Física, Química, Ciencias de la Tierra, Inglés, Dinámicas Sociales/Ambientales, Gestión Digital, Alfabetización, Práctica I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Gestión de Residuos, Química Ambiental, Contaminación/Toxicología, EDI I, Economía Ambiental, Ecología/Desarrollo Sostenible, Metodología, Práctica II</li>
<li><b>3° Año:</b>  Educación/Comunicación Ambiental, Ordenamiento Ambiental, Ética, Sistemas de Gestión y Auditorías, Evaluación de Impacto Ambiental, Seguridad Ambiental/Laboral, EDI II, Gestión Ambiental Minera, Planificación de Proyectos, Práctica III</li></ul>",
            "Le recordamos que el plan de estudios oficial para Gestión Ambiental consta de:<br><ul><li><b>1° Año:</b>  Biología, Matemática y Estadística, Física, Química, Ciencias de la Tierra, Inglés, Dinámicas Sociales y Ambientales, Gestión Ambiental Digital, Alfabetización Académica y Comunicación, y Práctica Profesionalizante I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Gestión de Residuos, Química Ambiental, Contaminación y Toxicología Ambiental, Espacio de Definición Institucional I (EDI I), Economía Ambiental, Ecología y Desarrollo Sostenible, Metodología de la Investigación y Práctica Profesionalizante II</li>
<li><b>3° Año:</b>  Educación y Comunicación Ambiental, Ordenamiento Ambiental del Territorio, Ética y Deontología Profesional, Sistemas de Gestión y Auditorías Ambientales, Evaluaciones de Impacto Ambiental, Seguridad Ambiental y Laboral, EDI II, Gestión Ambiental Minera, Planificación y Gestión de Proyectos, y Práctica Profesional III. Quedamos a su disposición para cualquier aclaración</li></ul>"
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Gestión Ambiental:<br><ul><li><b>1° Año:</b>  Biología, Matemática y Estadística, Física, Química, Ciencias de la Tierra, Inglés, Dinámicas Sociales, Gestión Digital, Alfabetización y Práctica I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Gestión de Residuos, Química Ambiental, Contaminación, EDI I, Economía, Ecología, Metodología y Práctica II</li>
<li><b>3° Año:</b>  Educación Ambiental, Ordenamiento Territorial, Ética, Auditorías Ambientales, Evaluación de Impacto, Seguridad Ambiental, EDI II, Gestión Minera, Proyectos y Práctica III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias oficiales de Gestión Ambiental son:<br><ul><li><b>1° Año:</b>  Biología, Matemática, Física, Química, Cs. de la Tierra, Inglés, Dinámicas Sociales, Gestión Digital, Alfabetización, Práctica I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Residuos, Química Ambiental, Toxicología, EDI I, Economía Ambiental, Ecología, Metodología, Práctica II</li>
<li><b>3° Año:</b>  Educación Ambiental, Ordenamiento Territorial, Ética, Auditorías, Impacto Ambiental, Seguridad, EDI II, Gestión Minera, Proyectos, Práctica III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Gestión Ambiental:<br><ul><li><b>1° Año:</b>  Biología, Matemática y Estadística, Física, Química, Ciencias de la Tierra, Inglés, Dinámicas Sociales, Gestión Digital, Alfabetización y Práctica I</li>
<li><b>2° Año:</b>  Derecho Ambiental, Gestión de Residuos, Química Ambiental, Contaminación, EDI I, Economía, Ecología, Metodología y Práctica II</li>
<li><b>3° Año:</b>  Educación Ambiental, Ordenamiento Territorial, Ética, Auditorías Ambientales, Evaluación de Impacto, Seguridad Ambiental, EDI II, Gestión Minera, Proyectos y Práctica III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    ninez_adolescencia_familia: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para la Tecnicatura en Niñez, Adolescencia y Familia consta de la siguiente estructura anual:<br><ul><li><b>1° Año:</b>  se cursan Introducción a la Niñez, Adolescencia y Familia, Sistema de Protección de Derechos, Recursos de la Comunidad, Metodología de la Investigación Social, Sociología de la Infancia y Adolescencia, Psicología de los Ciclos Vitales, Alfabetización Académica y Comunicación, Informática y Nuevas Tecnologías, y Práctica Profesionalizante I</li>
<li><b>2° Año:</b>  se cursan Derecho de Niñez, Adolescencia y Familia, Problemáticas de Niñez, Adolescencia y Familia I, Planificación Sociocomunitaria, Políticas Públicas, Dispositivos de Intervención Grupal, Estadística Descriptiva Aplicada, Salud Mental, EDI I, y Práctica Profesionalizante II</li>
<li><b>3° Año:</b>  se cursan Problemáticas de Niñez, Adolescencia y Familia II, Adolescentes en Conflicto con la Ley, Salud Integral y Políticas de Cuidado, Familia y Discapacidad, Mediación y Resolución de Conflictos, Seminario de Sistematización, Ética Profesional, EDI II, y Práctica Profesionalizante III</li></ul>",
            "Le detallamos la distribución anual de materias de Niñez y Familia:<br><ul><li><b>1° Año:</b>  Introducción a la Niñez, Adolescencia y Familia, Sistema de Protección de Derechos, Recursos de la Comunidad, Metodología de la Investigación, Sociología de la Infancia, Psicología de los Ciclos Vitales, Alfabetización Académica, Informática, Práctica I</li>
<li><b>2° Año:</b>  Derecho de Niñez, Problemáticas I, Planificación Sociocomunitaria, Políticas Públicas, Dispositivos Grupales, Estadística, Salud Mental, EDI, Práctica II</li>
<li><b>3° Año:</b>  Problemáticas II, Adolescentes en Conflicto con la Ley, Salud Integral, Familia y Discapacidad, Mediación, Seminario de Sistematización, Ética, EDI II, Práctica III</li></ul>",
            "Le recordamos que el plan de estudios oficial para la Tecnicatura en Niñez, Adolescencia y Familia consta de la siguiente estructura anual:<br><ul><li><b>1° Año:</b>  se cursan Introducción a la Niñez, Adolescencia y Familia, Sistema de Protección de Derechos, Recursos de la Comunidad, Metodología de la Investigación Social, Sociología de la Infancia y Adolescencia, Psicología de los Ciclos Vitales, Alfabetización Académica y Comunicación, Informática y Nuevas Tecnologías, y Práctica Profesionalizante I</li>
<li><b>2° Año:</b>  se cursan Derecho de Niñez, Adolescencia y Familia, Problemáticas de Niñez, Adolescencia y Familia I, Planificación Sociocomunitaria, Políticas Públicas, Dispositivos de Intervención Grupal, Estadística Descriptiva Aplicada, Salud Mental, EDI I, y Práctica Profesionalizante II</li>
<li><b>3° Año:</b>  se cursan Problemáticas de Niñez, Adolescencia y Familia II, Adolescentes en Conflicto con la Ley, Salud Integral y Políticas de Cuidado, Familia y Discapacidad, Mediación y Resolución de Conflictos, Seminario de Sistematización, Ética Profesional, EDI II, y Práctica Profesionalizante III. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Niñez, Adolescencia y Familia:<br><ul><li><b>1° Año:</b>  Introducción a la Niñez, Protección de Derechos, Recursos de la Comunidad, Metodología de Investigación, Sociología de Infancia, Psicología, Alfabetización, Informática y Práctica I</li>
<li><b>2° Año:</b>  Derecho, Problemáticas I, Planificación, Políticas Públicas, Intervención Grupal, Estadística, Salud Mental, EDI, Práctica II</li>
<li><b>3° Año:</b>  Problemáticas II, Conflicto con la Ley, Salud Integral, Familia y Discapacidad, Mediación, Seminario, Ética, EDI II y Práctica III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias de la tecnicatura por año son:<br><ul><li><b>1° Año:</b>  Introducción a la Niñez, Protección de Derechos, Recursos, Metodología, Sociología, Psicología, Alfabetización, Informática, Práctica I</li>
<li><b>2° Año:</b>  Derecho, Problemáticas I, Planificación, Políticas Públicas, Intervención Grupal, Estadística, Salud Mental, EDI, Práctica II</li>
<li><b>3° Año:</b>  Problemáticas II, Conflicto con la Ley, Salud Integral, Familia y Discapacidad, Mediación, Seminario, Ética, EDI II, Práctica III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Niñez, Adolescencia y Familia:<br><ul><li><b>1° Año:</b>  Introducción a la Niñez, Protección de Derechos, Recursos de la Comunidad, Metodología de Investigación, Sociología de Infancia, Psicología, Alfabetización, Informática y Práctica I</li>
<li><b>2° Año:</b>  Derecho, Problemáticas I, Planificación, Políticas Públicas, Intervención Grupal, Estadística, Salud Mental, EDI, Práctica II</li>
<li><b>3° Año:</b>  Problemáticas II, Conflicto con la Ley, Salud Integral, Familia y Discapacidad, Mediación, Seminario, Ética, EDI II y Práctica III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
...
<li><b>2° Año:</b>  se cursan Inmunología y serología, Primeros auxilios, Ética y aspectos legales en salud, Metodología de la Investigación en salud, Microbiología humana, Doctrina social de la Iglesia, Práctica de laboratorio II, Tecnología de la información y la comunicación, e Higiene y Seguridad</li>
<li><b>3° Año:</b>  se cursan Inmunohematología, Humanización en salud, Bioética, Fisiopatología aplicada, Bioquímica Clínica II, Práctica de laboratorio III, Organización y gestión de las instituciones de salud, e Inglés técnico</li></ul>",
            "Le detallamos la distribución anual de materias de Análisis Clínicos:<br><ul><li><b>1° Año:</b>  Procesos tecnológicos, Física y matemática, Formación religiosa, Psicología evolutiva, Química, Anatomía/histología/fisiología, Práctica de laboratorio I, Salud pública, Bioquímica clínica</li>
<li><b>2° Año:</b>  Inmunología/serología, Primeros auxilios, Ética y aspectos legales, Metodología, Microbiología humana, Doctrina social de la Iglesia, Práctica II, TIC, Higiene y Seguridad</li>
<li><b>3° Año:</b>  Inmunohematología, Humanización, Bioética, Fisiopatología aplicada, Bioquímica Clínica II, Práctica III, Organización y gestión, Inglés técnico</li></ul>",
            "Le recordamos que el plan de estudios oficial para Laboratorio de Análisis Clínicos se estructura de la siguiente manera:<br><ul><li><b>1° Año:</b>  se cursan Procesos tecnológicos de laboratorio, Física y matemática, Formación religiosa, Psicología evolutiva, Química, Anatomía, histología y fisiología, Práctica de laboratorio I, Salud pública y Bioquímica clínica</li>
<li><b>2° Año:</b>  se cursan Inmunología y serología, Primeros auxilios, Ética y aspectos legales en salud, Metodología de la Investigación en salud, Microbiología humana, Doctrina social de la Iglesia, Práctica de laboratorio II, Tecnología de la información y la comunicación, e Higiene y Seguridad</li>
<li><b>3° Año:</b>  se cursan Inmunohematología, Humanización en salud, Bioética, Fisiopatología aplicada, Bioquímica Clínica II, Práctica de laboratorio III, Organización y gestión de las instituciones de salud, e Inglés técnico. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. El plan de estudios de la carrera consta de:<br><ul><li><b>1° Año:</b>  Procesos de laboratorio, Física y matemática, Formación religiosa, Psicología, Química, Anatomía/fisiología, Práctica I, Salud pública, Bioquímica clínica</li>
<li><b>2° Año:</b>  Inmunología, Primeros auxilios, Ética, Metodología, Microbiología, Doctrina social, Práctica II, TIC, Higiene y Seguridad</li>
<li><b>3° Año:</b>  Inmunohematología, Humanización, Bioética, Fisiopatología, Bioquímica Clínica II, Práctica III, Organización de salud, Inglés técnico</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las asignaturas obligatorias por año son:<br><ul><li><b>1° Año:</b>  Procesos, Física/Matemática, Religión, Psicología, Química, Anatomía, Práctica I, Salud Pública, Bioquímica</li>
<li><b>2° Año:</b>  Inmunología, Primeros Auxilios, Ética, Metodología, Microbiología, Doctrina Social, Práctica II, TIC, Higiene</li>
<li><b>3° Año:</b>  Inmunohematología, Humanización, Bioética, Fisiopatología, Bioquímica II, Práctica III, Organización, Inglés Técnico</li></ul>",
...
<li><b>2° Año:</b>  Inmunología, Primeros auxilios, Ética, Metodología, Microbiología, Doctrina social, Práctica II, TIC, Higiene y Seguridad</li>
<li><b>3° Año:</b>  Inmunohematología, Humanización, Bioética, Fisiopatología, Bioquímica Clínica II, Práctica III, Organización de salud, Inglés técnico. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    hemoterapia: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Hemoterapia se estructura en 3 años:<br><ul><li><b>1° Año:</b>  se cursan Educación y salud, Biología, genética e inmunología, Anatomía y fisiología humana, Hemoterapia y hemodonación, Psicología evolutiva, Metodología de la investigación, Primeros auxilios, Higiene y seguridad laboral, Práctica I y EDI I</li>
<li><b>2° Año:</b>  se cursan Microbiología y epidemiología, Calificación biológica, Taller de calificación biológica, Ética y aspectos legales en hemoterapia, Preparación de productos sanguíneos, Inglés técnico, Informática, Práctica II y EDI I</li>
<li><b>3° Año:</b>  se cursan Fisiología feto-neonatal, Gestión y calidad en bancos de sangre, Bioética, Fisiopatología aplicada, Transfusión, Psicología de las organizaciones de la salud, Inmunohematología, Práctica III y EDI II</li></ul>",
            "Le detallamos la distribución anual de materias de Hemoterapia:<br><ul><li><b>1° Año:</b>  Educación y salud, Biología/genética/inmunología, Anatomía/fisiología, Hemoterapia/hemodonación, Psicología evolutiva, Metodología, Primeros auxilios, Higiene/seguridad, Práctica I, EDI I</li>
<li><b>2° Año:</b>  Microbiología/epidemiología, Calificación biológica, Taller de calificación, Ética y aspectos legales, Preparación de productos sanguíneos, Inglés técnico, Informática, Práctica II, EDI I</li>
<li><b>3° Año:</b>  Fisiología feto-neonatal, Gestión/calidad en bancos de sangre, Bioética, Fisiopatología aplicada, Transfusión, Psicología organizacional, Inmunohematología, Práctica III, EDI II</li></ul>",
            "Le recordamos que el plan de estudios oficial para Hemoterapia se estructura en 3 años:<br><ul><li><b>1° Año:</b>  se cursan Educación y salud, Biología, genética e inmunología, Anatomía y fisiología humana, Hemoterapia y hemodonación, Psicología evolutiva, Metodología de la investigación, Primeros auxilios, Higiene y seguridad laboral, Práctica I y EDI I</li>
<li><b>2° Año:</b>  se cursan Microbiología y epidemiología, Calificación biológica, Taller de calificación biológica, Ética y aspectos legales en hemoterapia, Preparación de productos sanguíneos, Inglés técnico, Informática, Práctica II y EDI I</li>
<li><b>3° Año:</b>  se cursan Fisiología feto-neonatal, Gestión y calidad en bancos de sangre, Bioética, Fisiopatología aplicada, Transfusión, Psicología de las organizaciones de la salud, Inmunohematología, Práctica III y EDI II. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Hemoterapia:<br><ul><li><b>1° Año:</b>  Educación y salud, Biología, Anatomía/fisiología, Hemoterapia/hemodonación, Psicología, Metodología, Primeros auxilios, Higiene, Práctica I, EDI I</li>
<li><b>2° Año:</b>  Microbiología, Calificación biológica, Taller, Ética, Preparación de productos, Inglés, Informática, Práctica II, EDI I</li>
<li><b>3° Año:</b>  Fisiología feto-neonatal, Gestión de bancos, Bioética, Fisiopatología, Transfusión, Psicología, Inmunohematología, Práctica III, EDI II</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias de la tecnicatura por año son:<br><ul><li><b>1° Año:</b>  Educación/Salud, Biología/Genética, Anatomía, Hemoterapia, Psicología, Metodología, Primeros Auxilios, Higiene, Práctica I, EDI I</li>
<li><b>2° Año:</b>  Microbiología, Calificación Biológica, Taller, Ética, Preparación de Productos, Inglés, Informática, Práctica II, EDI I</li>
<li><b>3° Año:</b>  Fisiología feto-neonatal, Gestión, Bioética, Fisiopatología, Transfusión, Psicología, Inmunohematología, Práctica III, EDI II</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Hemoterapia:<br><ul><li><b>1° Año:</b>  Educación y salud, Biología, Anatomía/fisiología, Hemoterapia/hemodonación, Psicología, Metodología, Primeros auxilios, Higiene, Práctica I, EDI I</li>
<li><b>2° Año:</b>  Microbiología, Calificación biológica, Taller, Ética, Preparación de productos, Inglés, Informática, Práctica II, EDI I</li>
<li><b>3° Año:</b>  Fisiología feto-neonatal, Gestión de bancos, Bioética, Fisiopatología, Transfusión, Psicología, Inmunohematología, Práctica III, EDI II. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
...
<li><b>2° Año:</b>  se cursan Neurofisiopatología, Metodología de la investigación, Teorías y estrategias de abordaje en el acompañamiento terapéutico, Psicología del desarrollo del adulto y el adulto mayor, Psicopatología I, Estrategia de abordaje familiar, Psicomotricidad aplicada al acompañamiento terapéutico, Análisis de las organizaciones e instituciones, Dinámica de grupo y Práctica de acercamiento al campo</li>
<li><b>3° Año:</b>  se cursan Bioética y deontología, Principios de farmacología, Psicopatología II, TIC en el acompañamiento terapéutico, Discapacidad e inclusión, Técnicas de abordaje del acompañamiento terapéutico, Taller de redacción de informes, Taller de casos clínicos, Abordaje de urgencias en salud mental, Práctica profesionalizante III y EDI</li></ul>",
            "Le detallamos la distribución anual de materias de Acompañamiento Terapéutico:<br><ul><li><b>1° Año:</b>  Introducción al acompañamiento, Primeros auxilios, Bases biológicas, Psicología general, Psicología del desarrollo (niñez/adolescencia), Psicología social, Políticas públicas/legislación, Cristología, Prácticas I</li>
<li><b>2° Año:</b>  Neurofisiopatología, Metodología, Teorías y estrategias de abordaje, Psicología del desarrollo (adulto/mayor), Psicopatología I, Abordaje familiar, Psicomotricidad aplicada, Análisis organizacional, Dinámica de grupo, Práctica de campo</li>
<li><b>3° Año:</b>  Bioética/deontología, Farmacología, Psicopatología II, TIC, Discapacidad/inclusión, Técnicas de abordaje, Redacción de informes, Casos clínicos, Urgencias en salud mental, Prácticas III y EDI</li></ul>",
            "Le recordamos que el plan de estudios oficial para Acompañamiento Terapéutico consta de la siguiente estructura anual:<br><ul><li><b>1° Año:</b>  se cursan Introducción al acompañamiento terapéutico, Primeros auxilios, Bases biológicas del comportamiento humano, Psicología general, Psicología del desarrollo de la niñez y la adolescencia, Psicología social y comunitaria, Políticas públicas y legislación en salud, Cristología y Prácticas profesionalizantes I</li>
<li><b>2° Año:</b>  se cursan Neurofisiopatología, Metodología de la investigación, Teorías y estrategias de abordaje en el acompañamiento terapéutico, Psicología del desarrollo del adulto y el adulto mayor, Psicopatología I, Estrategia de abordaje familiar, Psicomotricidad aplicada al acompañamiento terapéutico, Análisis de las organizaciones e instituciones, Dinámica de grupo y Práctica de acercamiento al campo</li>
<li><b>3° Año:</b>  se cursan Bioética y deontología, Principios de farmacología, Psicopatología II, TIC en el acompañamiento terapéutico, Discapacidad e inclusión, Técnicas de abordaje del acompañamiento terapéutico, Taller de redacción de informes, Taller de casos clínicos, Abordaje de urgencias en salud mental, Práctica profesionalizante III y EDI. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos la demora. A continuación le detallamos el plan de estudios de Acompañamiento Terapéutico:<br><ul><li><b>1° Año:</b>  Introducción, Primeros auxilios, Bases biológicas, Psicología (general, desarrollo, social), Políticas de salud, Cristología y Prácticas I</li>
<li><b>2° Año:</b>  Neurofisiopatología, Metodología, Estrategias de abordaje, Psicología del adulto, Psicopatología I, Abordaje familiar, Psicomotricidad, Análisis institucional, Dinámica de grupo y Prácticas</li>
<li><b>3° Año:</b>  Bioética, Farmacología, Psicopatología II, TIC, Discapacidad/inclusión, Técnicas, Informes, Casos clínicos, Urgencias, Prácticas III y EDI</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias oficiales por año son:<br><ul><li><b>1° Año:</b>  Introducción al acompañamiento, Primeros Auxilios, Bases Biológicas, Psicología (General, Desarrollo, Social), Políticas, Cristología, Prácticas I</li>
<li><b>2° Año:</b>  Neurofisiopatología, Metodología, Teorías y abordajes, Psicología Adulto, Psicopatología I, Estrategia Familiar, Psicomotricidad, Análisis Institucional, Dinámica de Grupo, Prácticas</li>
<li><b>3° Año:</b>  Bioética, Farmacología, Psicopatología II, TIC, Discapacidad/Inclusión, Técnicas, Redacción Informes, Casos Clínicos, Urgencias Mental, Prácticas III, EDI</li></ul>",
...
<li><b>2° Año:</b>  Neurofisiopatología, Metodología, Estrategias de abordaje, Psicología del adulto, Psicopatología I, Abordaje familiar, Psicomotricidad, Análisis institucional, Dinámica de grupo y Prácticas</li>
<li><b>3° Año:</b>  Bioética, Farmacología, Psicopatología II, TIC, Discapacidad/inclusión, Técnicas, Informes, Casos clínicos, Urgencias, Prácticas III y EDI. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    administracion_empresas: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial para Administración de Empresas consta de:<br><ul><li><b>1° Año:</b>  se cursan Introducción a la administración, Macroeconomía, Fundamentos de contabilidad sistemática, Matemática, EDI I, Derecho civil y comercial, Psicología y comportamiento organizacional, y Práctica profesionalizante I</li>
<li><b>2° Año:</b>  se cursan Sistemas administrativos, Marketing, Gestión de capital humano, Contabilidad para la gestión, Estadística aplicada a la administración, Derecho laboral y societario, Microeconomía, economía regional y desarrollo local, y Práctica profesionalizante II</li>
<li><b>3° Año:</b>  se cursan Formulación y evaluación de proyectos, Administración financiera, Gestión de logística en Pyme, Gestión de Pyme y empresas familiares, Costos y presupuesto, Informática, Liderazgo y ambiente laboral, EDI II, y Práctica profesionalizante III</li></ul>",
            "Le detallamos la distribución anual de materias de Administración:<br><ul><li><b>1° Año:</b>  Introducción a la administración, Macroeconomía, Fundamentos de contabilidad, Matemática, EDI I, Derecho civil/comercial, Psicología organizacional, Prácticas I</li>
<li><b>2° Año:</b>  Sistemas administrativos, Marketing, Capital humano, Contabilidad para la gestión, Estadística aplicada, Derecho laboral/societario, Microeconomía/desarrollo local, Prácticas II</li>
<li><b>3° Año:</b>  Formulación y evaluación de proyectos, Administración financiera, Logística en Pyme, Gestión de Pyme/empresas familiares, Costos y presupuesto, Informática, Liderazgo, EDI II, Prácticas III</li></ul>",
            "Le recordamos que el plan de estudios oficial para Administración de Empresas consta de:<br><ul><li><b>1° Año:</b>  se cursan Introducción a la administración, Macroeconomía, Fundamentos de contabilidad sistemática, Matemática, EDI I, Derecho civil y comercial, Psicología y comportamiento organizacional, y Práctica profesionalizante I</li>
<li><b>2° Año:</b>  se cursan Sistemas administrativos, Marketing, Gestión de capital humano, Contabilidad para la gestión, Estadística aplicada a la administración, Derecho laboral y societario, Microeconomía, economía regional y desarrollo local, y Práctica profesionalizante II</li>
<li><b>3° Año:</b>  se cursan Formulación y evaluación de proyectos, Administración financiera, Gestión de logística en Pyme, Gestión de Pyme y empresas familiares, Costos y presupuesto, Informática, Liderazgo y ambiente laboral, EDI II, y Práctica profesionalizante III. Quedamos a su disposición para cualquier aclaración</li></ul>"
        ],
            informal: [
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Administración de Empresas:<br><ul><li><b>1° Año:</b>  Introducción a la administración, Macroeconomía, Fundamentos de contabilidad, Matemática, EDI I, Derecho civil/comercial, Psicología organizacional, Prácticas I</li>
<li><b>2° Año:</b>  Sistemas administrativos, Marketing, Capital humano, Contabilidad para la gestión, Estadística aplicada, Derecho laboral/societario, Microeconomía/desarrollo local, Prácticas II</li>
<li><b>3° Año:</b>  Formulación y evaluación de proyectos, Administración financiera, Logística en Pyme, Gestión de Pyme/empresas familiares, Costos y presupuesto, Informática, Liderazgo, EDI II, Prácticas III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias obligatorias de Administración por año son:<br><ul><li><b>1° Año:</b>  Introducción, Macroeconomía, Contabilidad, Matemática, EDI I, Derecho civil y comercial, Psicología, Práctica I</li>
<li><b>2° Año:</b>  Sistemas, Marketing, Capital Humano, Contabilidad Gestión, Estadística, Derecho laboral, Microeconomía, Práctica II</li>
<li><b>3° Año:</b>  Formulación Proyectos, Finanzas, Logística, Pymes y Empresas Familiares, Costos, Informática, Liderazgo, EDI II, Práctica III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le detallamos el plan de estudios completo de Administración de Empresas:<br><ul><li><b>1° Año:</b>  Introducción a la administración, Macroeconomía, Fundamentos de contabilidad, Matemática, EDI I, Derecho civil/comercial, Psicología organizacional, Prácticas I</li>
<li><b>2° Año:</b>  Sistemas administrativos, Marketing, Capital humano, Contabilidad para la gestión, Estadística aplicada, Derecho laboral/societario, Microeconomía/desarrollo local, Prácticas II</li>
<li><b>3° Año:</b>  Formulación y evaluación de proyectos, Administración financiera, Logística en Pyme, Gestión de Pyme/empresas familiares, Costos y presupuesto, Informática, Liderazgo, EDI II, Prácticas III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
    ...
    administracion_publica: {
        ...
        plan_estudios_completo: {
            formal: [
            "El plan de estudios oficial de Administración Pública consta de:<br><ul><li><b>1° Año:</b>  se cursan Administración pública, Análisis de la realidad socioeconómica y política, Teología I, Introducción al derecho, Sistemas de comunicación en la gestión estatal, Economía, Antropología socio cultural y Práctica profesionalizante I</li>
<li><b>2° Año:</b>  se cursan Contabilidad pública, Matemática financiera y estadística, Derecho administrativo, Psicología social de las organizaciones, Metodología de la investigación social, Recursos humanos, Economía regional y desarrollo local, y Práctica profesionalizante II</li>
<li><b>3° Año:</b>  se cursan Políticas públicas, Tecnologías de la información y la comunicación, Planificación y gestión del desarrollo local, Administración financiera, Formulación y evaluación de proyectos, Evaluación y control de gestión, Ética y doctrina social de la Iglesia, y Práctica profesionalizante III</li></ul>",
            "Le detallamos la distribución anual de materias de Administración Pública:<br><ul><li><b>1° Año:</b>  Administración pública, Análisis socioeconómico/político, Teología I, Introducción al derecho, Sistemas de comunicación, Economía, Antropología, Prácticas I</li>
<li><b>2° Año:</b>  Contabilidad pública, Matemática financiera/estadística, Derecho administrativo, Psicología social de organizaciones, Metodología, Recursos humanos, Economía regional, Prácticas II</li>
<li><b>3° Año:</b>  Políticas públicas, TIC, Planificación y gestión de desarrollo local, Administración financiera, Formulación y evaluación de proyectos, Evaluación/control de gestión, Ética y doctrina social, Prácticas III</li></ul>",
...
<li><b>3° Año:</b>  se cursan Políticas públicas, Tecnologías de la información y la comunicación, Planificación y gestión del desarrollo local, Administración financiera, Formulación y evaluación de proyectos, Evaluación y control de gestión, Ética y doctrina social de la Iglesia, y Práctica profesionalizante III. Quedamos a su disposición para cualquier aclaración</li></ul>"
            ...
            molesto: [
            "Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Administración Pública:<br><ul><li><b>1° Año:</b>  Administración pública, Análisis socioeconómico, Teología I, Introducción al derecho, Sistemas de comunicación, Economía, Antropología, Prácticas I</li>
<li><b>2° Año:</b>  Contabilidad pública, Matemática financiera, Derecho administrativo, Psicología social, Metodología, Recursos humanos, Economía regional, Prácticas II</li>
<li><b>3° Año:</b>  Políticas públicas, TIC, Planificación local, Administración financiera, Formulación de proyectos, Control de gestión, Ética, Prácticas III</li></ul>",
            "Pedimos disculpas por los inconvenientes. Las materias oficiales son:<br><ul><li><b>1° Año:</b>  Administración pública, Análisis realidad, Teología I, Introducción al derecho, Sistemas de comunicación, Economía, Antropología, Práctica I</li>
<li><b>2° Año:</b>  Contabilidad pública, Matemática financiera, Derecho administrativo, Psicología social, Metodología, Recursos humanos, Economía regional, Práctica II</li>
<li><b>3° Año:</b>  Políticas públicas, TIC, Desarrollo local, Administración financiera, Evaluación proyectos, Control de gestión, Ética, Práctica III</li></ul>",
            "Lamentamos las dificultades iniciales. Le informamos de manera prioritaria: Lamentamos sinceramente la demora. A continuación le presentamos el plan de estudios completo de Administración Pública:<br><ul><li><b>1° Año:</b>  Administración pública, Análisis socioeconómico, Teología I, Introducción al derecho, Sistemas de comunicación, Economía, Antropología, Prácticas I</li>
<li><b>2° Año:</b>  Contabilidad pública, Matemática financiera, Derecho administrativo, Psicología social, Metodología, Recursos humanos, Economía regional, Prácticas II</li>
<li><b>3° Año:</b>  Políticas públicas, TIC, Planificación local, Administración financiera, Formulación de proyectos, Control de gestión, Ética, Prácticas III. Agradecemos su comprensión</li></ul>"
        ]
        },
        campo_laboral: {
            formal: [
