...
const RESPUESTAS_GENERALES = {
    ...
    sede_san_pedro: {
        formal: ["La Sede San Pedro dispone de la siguiente oferta académica:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado de Educación Especial\">Prof. Especial (Sordos/Hipo)</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Historia\">Prof. Historia</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Desarrollo de Software\">Des. Software</button></div>"],
        informal: ["¡Mirá las carreras que podés cursar en la Sede San Pedro!:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado de Educación Especial\">Prof. Especial (Sordos/Hipo)</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Historia\">Prof. Historia</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Desarrollo de Software\">Des. Software</button></div>"],
        molesto: ["Las opciones para Sede San Pedro son:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado de Educación Especial\">Prof. Especial (Sordos/Hipo)</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Historia\">Prof. Historia</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Desarrollo de Software\">Des. Software</button></div>"]
    },
    sede_libertador: {
        formal: ["En la Sede Libertador, la institución dicta las siguientes carreras:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Psicología\">Prof. Psicología</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Automatización y Robótica\">Aut. y Robótica</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Acompañamiento Terapéutico\">Acomp. Terapéutico</button></div>"],
        informal: ["¡Te muestro las opciones de la Sede Libertador! Hacé clic en la que te interese:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Psicología\">Prof. Psicología</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Automatización y Robótica\">Aut. y Robótica</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Acompañamiento Terapéutico\">Acomp. Terapéutico</button></div>"],
        molesto: ["La oferta de la Sede Libertador comprende las siguientes carreras:<br><br><div class=\"btn-list\"><button class=\"quick-btn inline-quick-btn\" data-msg=\"Profesorado en Psicología\">Prof. Psicología</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Automatización y Robótica\">Aut. y Robótica</button><button class=\"quick-btn inline-quick-btn\" data-msg=\"Acompañamiento Terapéutico\">Acomp. Terapéutico</button></div>"]
    },
    carreras: {
        formal: [
...
const RESPUESTAS_CARRERA = {
    carrera_mecatronica: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>El Técnico en Mecatrónica está capacitado para integrar, coordinar o supervisar un equipo de trabajo en organizaciones dedicadas a la mecánica, metalmecánica, producción industrial o automatización. Se dedicará al desarrollo de productos, elaboración de proyectos y programación de equipos."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>Vas a aprender a desarrollar proyectos de automatización, programar controladores y mantener equipos mecatrónicos. Ideal si te gusta la robótica y la tecnología industrial."],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>Le informamos que esta tecnicatura capacita para integrar y coordinar equipos en áreas de mecánica, producción industrial y automatización."]
        },
        plan_estudios_completo: {
    ...
    carrera_software: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>El Técnico Superior en Desarrollo de Software estará capacitado para producir artefactos de software, comprendiendo diseño, construcción, verificación unitaria, depuración, optimización y mantenimiento. Participa en proyectos de desarrollo y programación de sistemas."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>Vas a aprender a programar a fondo, diseñar software, armar bases de datos y testear sistemas. ¡La salida laboral es gigante!"],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>Le informamos que el técnico está capacitado para producir artefactos de software, diseño detallado y programación entera."]
        },
        plan_estudios_completo: {
    ...
    carrera_automatizacion: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>El técnico en Automatización y Robótica es un profesional capacitado para integrar y supervisar equipos dedicados a la tecnología de automatización y robótica, en áreas mecánicas y de programación industrial."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>Vas a diseñar, analizar y programar sistemas automatizados y robóticos para cualquier tipo de industria."],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>Le informamos que la carrera forma técnicos para supervisar equipos de producción industrial, automatización y robótica."]
        },
        plan_estudios_completo: {
    ...
    carrera_lengua: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>El Profesorado de Educación Secundaria en Lengua y Literatura (4 años) forma docentes para planificar, desarrollar y evaluar procesos de enseñanza y aprendizaje en la educación secundaria, y participar en equipos interdisciplinarios para proyectos educativos vinculados a la Lengua y la Literatura."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>Es un profesorado de 4 años para enseñar Lengua y Literatura en el secundario, desarrollando proyectos educativos súper interesantes."],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede Perico**.<br><br>Esta carrera de 4 años forma docentes capacitados para la enseñanza secundaria en Lengua y Literatura."]
        },
        plan_estudios_completo: {
    ...
    carrera_historia: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>El Profesorado de Educación Secundaria en Historia (4 años) forma docentes capacitados para guiar y evaluar procesos de enseñanza de la historia en nivel secundario, teniendo en cuenta las características de los estudiantes y el contexto escolar."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>Es un profe de 4 años ideal si te apasiona la historia. Vas a aprender a dar clases copadas en el secundario conectando la historia con el contexto de los alumnos."],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede San Pedro**.<br><br>Le comunicamos que es una carrera docente de 4 años para el nivel secundario especializada en Historia."]
        },
        plan_estudios_completo: {
    ...
    carrera_psicologia: {
        descripcion_carrera: {
            formal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>El Profesorado de Educación Secundaria en Psicología (4 años) es un profesional con sólida formación disciplinar, pedagógica y tecnológica para planificar y desarrollar procesos de enseñanza de la psicología y resolver problemas emergentes en el ámbito escolar."],
            informal: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>Un profe de 4 años para dar psicología en el secundario, ser docente tutor o referente ESI, con mucha base en didáctica y pedagogía."],
            molesto: ["💡 Esta carrera se dicta exclusivamente en la **Sede Libertador**.<br><br>Carrera docente de 4 años enfocada en los procesos de enseñanza y aprendizaje del campo de la Psicología."]
        },
        plan_estudios_completo: {
